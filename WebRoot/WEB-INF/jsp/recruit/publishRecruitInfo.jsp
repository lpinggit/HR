...
#content #side2 table tr td #radio {
	...
	<form action="saveRecruitInfo.do" method="POST">
		<div id="content">
			<div id="side1">
				<div id="side1-1"></div>
				<div id="side1-2">
				...
				<div id="side3">
					...
					<div id="side4">
						<textarea rows="5" cols="110" name="jobDesc" style="font-size:13px;"></textarea>
					</div>
				</div>
				<div id="side4">
					<h3>
					...
					<div >
						<textarea  cols="96" rows="5" name="jobRequest" style="font-size:13px;"></textarea>
					</div>
				</div>
				<div id="side5">
					<h3>
						特殊要求：
						<br />
						<textarea name="specialRequest" cols="110" rows="2" style="font-size:13px;" ></textarea>						
					</h3>
				</div>
		</div>
		</form>
